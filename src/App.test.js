...
test('Performs Series of Actions', () => {
	...
	expect(
		within(cartItem1).getByTestId(IDMAPS.CART_ITEM_QUANTITY).innerHTML
	).toEqual('1');
	expect(
		within(cartItem1).getByTestId(IDMAPS.CART_ITEM_NAME).innerHTML
	).toEqual('Shirt');

	expect(
		within(cartItem2).getByTestId(IDMAPS.CART_ITEM_QUANTITY).innerHTML
	).toEqual('2');
	expect(
		within(cartItem2).getByTestId(IDMAPS.CART_ITEM_NAME).innerHTML
	).toEqual('Shoe');
	...
	subtractBtn = within(queryByTestId(IDMAPS.PRODUCT_ITEMS[2])).getByTestId(
		IDMAPS.SUBTRACT_BTN
	);
	fireEvent.click(subtractBtn);
